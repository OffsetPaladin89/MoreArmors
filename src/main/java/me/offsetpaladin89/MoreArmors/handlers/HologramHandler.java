...
public class HologramHandler {
	...
	public void createDamageHologram(Location pLoc, Location loc, Long duration, Double damage) {
		createDamageHologram(pLoc, loc, "&7" + new DecimalFormat("#.#").format(damage), duration);
	}
